 ...
 * @param dbInstance - The SQLite database instance to use
 */
 ...
 * This is a fallback method if drizzle-kit push doesn't work in runtime
 */
function createTables(db: Database.Database) {
  const tables = [
    ...
    // Products table (simplified for now - full schema would be very long)
