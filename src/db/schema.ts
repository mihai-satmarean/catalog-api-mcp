...
export const productProviders = sqliteTable('product_providers', {
  ...
  eco: integer('eco', { mode: 'boolean' }),
  traceability: text('traceability'),
  charity: text('charity'),
  pvcFree: integer('pvc_free', { mode: 'boolean' }),
  ...
  variableDataPrinting: integer('variable_data_printing', { mode: 'boolean' }),
  customSleevePossible: integer('custom_sleeve_possible', { mode: 'boolean' }),
  giftWrappingPossible: integer('gift_wrapping_possible', { mode: 'boolean' }),
  usp: text('usp'),
